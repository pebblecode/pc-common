...
namespace PebbleCode.Entities.Tests.Integration.Entities
{
	...
	/// </summary>
	[Serializable]
	public partial class VersionedThing : VersionedEntity<int>
	{
        /// <summary>
        /// Get the entity type
        /// </summary>
		public override Flags EntityFlag { get { return EntityType.VersionedThing; } }
    ...
    /// <summary>
    /// Event args class for VersionedThing
    /// </summary>
    public class VersionedThingEventArgs : EventArgs
    {
        public VersionedThing VersionedThing { get; private set; }
